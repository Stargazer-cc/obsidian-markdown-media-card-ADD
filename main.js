...
// node_modules/@zhouhua-dev/remark-media-card/dist/lib/utils.js
var langMap = {
  publishDate: {
    book: "\u51FA\u7248\u65F6\u95F4",
    music: "\u53D1\u884C\u65F6\u95F4",
...
var loadLocale = (locale2) => {
  if (loadedLocales[locale2]) return;
...
async function processObsidianUrl(url, sourcePath) {
  if (url.startsWith("obsidian://") || !url.startsWith("http://") && !url.startsWith("https://") && url.trim() !== "") {
    try {
      ...
      console.error("\u5904\u7406 Obsidian \u94FE\u63A5\u65F6\u51FA\u9519:", e3);
    }
  }
  return url;
}
